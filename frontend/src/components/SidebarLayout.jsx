...
export function SidebarLayout() {
  ...
  const roleMenus = {
    ...
    school_admin: [
      ...
      { path: '/curriculum', label: '📚 Kurikulum', icon: BookOpen },
      { path: '/classes', label: '🏫 Kelola Kelas & Program', icon: Building },
      { path: '/teachers', label: 'Kelola Data Guru', icon: Users },
      { path: '/students', label: 'Kelola Data Siswa', icon: GraduationCap },
      { path: '/sign-dictionary', label: '🤟 Kamus Isyarat Bergambar', icon: Sparkles },
      { path: '/library', label: '📂 Digital Library', icon: BookOpen },
    ],
    principal: [
      { path: '/dashboard', label: 'Monitoring Kepsek', icon: LayoutDashboard },
      { path: '/curriculum', label: '📚 Kurikulum Sekolah', icon: BookOpen },
      { path: '/daily-reports', label: '📝 Jurnal & Monitoring', icon: BookOpen },
      { path: '/development', label: '📊 Laporan Perkembangan', icon: Heart },
      { path: '/sign-dictionary', label: '🤟 Kamus Isyarat', icon: Sparkles },
      { path: '/library', label: '📂 Digital Library', icon: BookOpen },
    ],
    teacher: [
      { path: '/dashboard', label: 'Dashboard Guru', icon: LayoutDashboard },
      { path: '/curriculum', label: '📚 Kurikulum', icon: BookOpen },
      { path: '/classes', label: '🏫 Kelas & Program', icon: Building },
      { path: '/daily-reports', label: '📝 Jurnal Siswa & Laporan', icon: BookOpen },
      { path: '/daily-report', label: '+ Buat Jurnal Harian', icon: BookOpen },
      { path: '/ai-generator', label: '✨ AI Generator Narasi', icon: Sparkles },
      { path: '/lms-isyarat', label: '🤟 LMS Bahasa Isyarat', icon: Sparkles },
      { path: '/lms-indonesia', label: '📖 LMS Bahasa Indonesia', icon: BookOpen },
      { path: '/sign-dictionary', label: '🔍 Kamus Isyarat Bergambar', icon: Sparkles },
      { path: '/library', label: '📂 Digital Library & Buku', icon: BookOpen },
      { path: '/quizzes', label: '🎮 Kuis & Games', icon: Award },
      { path: '/students', label: '👩‍🎓 Siswa & Portfolio', icon: GraduationCap },
      { path: '/messaging', label: '💬 Pesan Orang Tua', icon: MessageSquare },
    ],
    parent: [
      { path: '/dashboard', label: 'Timeline Anak Hari Ini', icon: LayoutDashboard },
      { path: '/curriculum', label: '📚 Kurikulum Belajar', icon: BookOpen },
      { path: '/lms-isyarat', label: '🤟 LMS Bahasa Isyarat', icon: Sparkles },
      { path: '/lms-indonesia', label: '📖 LMS Bahasa Indonesia', icon: BookOpen },
      { path: '/sign-dictionary', label: '🔍 Kamus Isyarat Bergambar', icon: Sparkles },
      { path: '/library', label: '📂 Buku & Worksheet PDF', icon: BookOpen },
      { path: '/development', label: '📊 Perkembangan Anak', icon: Heart },
      { path: '/messaging', label: '💬 Chat Ustadzah', icon: MessageSquare },
    ],
    student: [
      { path: '/dashboard', label: 'Aktivitas Belajar Saya', icon: LayoutDashboard },
      { path: '/lms-isyarat', label: '🤟 Modul Bahasa Isyarat', icon: Sparkles },
      { path: '/lms-indonesia', label: '📖 Modul Bahasa Indonesia', icon: BookOpen },
      { path: '/sign-dictionary', label: '🔍 Kamus Isyarat Bergambar', icon: Sparkles },
      { path: '/library', label: '📂 Buku Bacaan & Lembar Kerja', icon: BookOpen },
